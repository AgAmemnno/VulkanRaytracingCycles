                                       ...
                                       const int max_steps = INT_MAX)
{
  ...
  PointerRNA cobject = RNA_pointer_get(&b_ob.ptr, "circus");
  ...
  if (b_parent.ptr.data != b_ob.ptr.data) {
    PointerRNA parent_cobject = RNA_pointer_get(&b_parent.ptr, "circus");
...
static inline Mesh::SubdivisionType object_subdivision_type(BL::Object &b_ob,
                                                            ...
                                                            bool experimental)
{
  PointerRNA cobj = RNA_pointer_get(&b_ob.ptr, "circus");
...
{
  PointerRNA cvisibility = RNA_pointer_get(&b_ob.ptr, "circus_visibility");
  uint flag = 0;
