...
{
  /* Sync recalc flags from blender to circus. Actual update is done separate,
                                             ...
                                             const DenoiseParams &denoising)
{
  ...
  PointerRNA crl = RNA_pointer_get(&b_view_layer.ptr, "circus");
...
SceneParams BlenderSync::get_scene_params(BL::Scene &b_scene, bool background)
{
  ...
  PointerRNA csscene = RNA_pointer_get(&b_scene.ptr, "circus_curves");
                                              ...
                                              bool background)
{
  ...
  if (background) {
    ...
    if (b_view_layer) {
      PointerRNA clayer = RNA_pointer_get(&b_view_layer.ptr, "circus");
