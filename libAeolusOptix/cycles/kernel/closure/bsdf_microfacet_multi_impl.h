                                                             ...
                                                             const float3 cspec0)
{
  ...
  /*
printf(" %.5f, %.5f, %.5f, ",beta(-lambda_r, shadowing_lambda + 1.0f), - lambda_r, shadowing_lambda + 1.0f);
if (stat_aux.hit % 1024 == 0)printf("\n");
stat_aux.add(&stat_aux.hit_rec_cnt[5], int(1));
*/
  stat_aux.add(&stat_aux.hit_rec_cnt[2], int(1000.f * eval.x));
