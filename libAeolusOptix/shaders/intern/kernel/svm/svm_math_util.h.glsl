#ifndef _SVM_MATH_UTIL_H_
#define  _SVM_MATH_UTIL_H_
/*
...
ccl_device void svm_vector_math(inout float value,
                                inout float3 vector,
...
/* Calculate color in_rsv range 800..12000 using an approximation
...
{
  /* TODO(lukas): Reimplement in_rsv XYZ. */

  if (t >= 12000.0f) {
    return make_float3(0.826270103f, 0.994478524f, 1.56626022f);
  }
  else if (t < 965.0f) {
    /* For 800 <= t < 965 color does not change in_rsv OSL implementation, so keep color the same */
