                                                    ...
                                                    float2 *dy2)
{
  if (sd->type & PRIMITIVE_ALL_TRIANGLE) {
    if (subd_triangle_patch(kg, sd) == ~0)
      return triangle_attribute_float2(kg, sd, desc, dx2, dy2);
    else
      return subd_triangle_attribute_float2(kg, sd, desc, dx2, dy2);
  }
#ifdef __HAIR__
  else if (sd->type & PRIMITIVE_ALL_CURVE) {
                                                    ...
                                                    float3 *dy3)
{
  if (sd->type & PRIMITIVE_ALL_TRIANGLE) {
    if (subd_triangle_patch(kg, sd) == ~0)
      return triangle_attribute_float3(kg, sd, desc, dx3, dy3);
    else
      return subd_triangle_attribute_float3(kg, sd, desc, dx3, dy3);
  }
#ifdef __HAIR__
  else if (sd->type & PRIMITIVE_ALL_CURVE) {
                                                    ...
                                                    float4 *dy4)
{
  if (sd->type & PRIMITIVE_ALL_TRIANGLE) {
    if (subd_triangle_patch(kg, sd) == ~0)
      return triangle_attribute_float4(kg, sd, desc, dx4, dy4);
    else
      return subd_triangle_attribute_float4(kg, sd, desc, dx4, dy4);
  }
#ifdef __HAIR__
  else if (sd->type & PRIMITIVE_ALL_CURVE) {
