...
ccl_device void differential_transfer(inout ccl_addr_space differential3 dP_,
...
ccl_device void differential_incoming(out ccl_addr_space differential3 dI, const differential3 dD)
{
...
ccl_device void differential_dudv(inout ccl_addr_space differential du,
                                  inout ccl_addr_space differential dv,
                                  float3 dPdu,
                                  float3 dPdv,
                                  differential3 dP,
                                  float3 Ng)
