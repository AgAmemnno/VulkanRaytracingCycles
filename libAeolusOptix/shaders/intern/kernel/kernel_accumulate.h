...
ccl_device_forceinline void path_radiance_clamp(KernelGlobals *kg, inout float3 L, int bounce)
{
...
#ifdef __PASSES__
  if (L->use_light_pass !=0) {
    if (bool(state->flag & PATH_RAY_TRANSPARENT_BACKGROUND))
