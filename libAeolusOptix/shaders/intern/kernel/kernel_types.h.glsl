...
typedef ccl_addr_space struct (16) ShaderData
{
  /* position */
  float3 P;
...
typedef
 ...
 struct _SubsurfaceIndirectRays { 
...
typedef
 ...
 struct _KernelLightDistribution { 
  float totarea;
  int prim;
  union {
    struct {
