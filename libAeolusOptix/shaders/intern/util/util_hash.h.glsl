...
{
  return float(hash_uint(kx)) / float(FFFFFFFF);
}

ccl_device_inline float hash_uint2_to_float(uint kx, uint ky)
{
  return float(hash_uint2(kx, ky)) / float(FFFFFFFF);
}

ccl_device_inline float hash_uint3_to_float(uint kx, uint ky, uint kz)
{
  return float(hash_uint3(kx, ky, kz)) / float(FFFFFFFF);
}

ccl_device_inline float hash_uint4_to_float(uint kx, uint ky, uint kz, uint kw)
{
  return float(hash_uint4(kx, ky, kz, kw)) / float(FFFFFFFF);
}
...
{
  return hash_uint2_to_float(_float_as_uint(k.x), _float_as_uint(k.y));
}

ccl_device_inline float hash_float3_to_float(float3 k)
{
  return hash_uint3_to_float(_float_as_uint(k.x), _float_as_uint(k.y), _float_as_uint(k.z));
}

ccl_device_inline float hash_float4_to_float(float4 k)
{
  return hash_uint4_to_float(
      _float_as_uint(k.x), _float_as_uint(k.y), _float_as_uint(k.z), _float_as_uint(k.w));
}
