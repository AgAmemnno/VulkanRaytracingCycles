...
/* Functions */
#ifdef __KERNEL_VULKAN
ccl_device_inline float3 transform_perspective(const in ProjectionTransform t, const float3 a)
{
...
ccl_device_inline float3 transform_perspective_direction(const in ProjectionTransform t,
                                                         const float3 a)
{
