...
#ifndef _UTIL_PROJECTION_H_
#define _UTIL_PROJECTION_H_

#include "util/util_transform.h.glsl"
...
ccl_device_inline float3 transform_perspective(in ProjectionTransform t, const float3 a)
{
...
ccl_device_inline float3 transform_perspective_direction(in ProjectionTransform t,
                                                         const float3 a)
{
