...
#  ifdef _KERNEL_SSE_
  ...
  _forceinline int4();
  _forceinline int4(const int4 &a);
  _forceinline explicit int4(const _m128i &a);

  _forceinline operator const _m128i &() const;
  _forceinline operator _m128i &();

  _forceinline int4 &operator=(const int4 &a);
#  else  /* _KERNEL_SSE_ */
  int x, y, z, w;
#  endif /* _KERNEL_SSE_ */
...
#define int4 ivec4
#define make_int4 ivec4
#define print_int4(label,a)
#endif
