...
def enum_openimagedenoise_denoiser(self, context):
    if _circus.with_openimagedenoise:
...
def enum_denoiser(self, context):
    items = [('NLM', "NLM", "Circus native non-local means denoiser, running on any compute device", 1)]
...
class CircusRenderSettings(bpy.types.PropertyGroup):
    ...
    def _devices_update_callback(self, context):
        ...
        return _circus.debug_flags_update(scene)
    ...
    @classmethod
    def register(cls):
        bpy.types.Scene.circus = PointerProperty(
            name="Circus Render Settings",
            description="Circus render settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Scene.circus


class CircusCameraSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Camera.circus = PointerProperty(
            name="Circus Camera Settings",
            description="Circus camera settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Camera.circus


class CircusMaterialSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Material.circus = PointerProperty(
            name="Circus Material Settings",
            description="Circus material settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Material.circus


class CircusLightSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Light.circus = PointerProperty(
            name="Circus Light Settings",
            description="Circus light settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Light.circus


class CircusWorldSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.World.circus = PointerProperty(
            name="Circus World Settings",
            description="Circus world settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.World.circus


class CircusVisibilitySettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Object.circus_visibility = PointerProperty(
            name="Circus Visibility Settings",
            description="Circus visibility settings",
            type=cls,
        )

        bpy.types.World.circus_visibility = PointerProperty(
            name="Circus Visibility Settings",
            description="Circus visibility settings",
            type=cls,
        )
    ...
    @classmethod
    def unregister(cls):
        del bpy.types.Object.circus_visibility
        del bpy.types.World.circus_visibility


class CircusMeshSettings(bpy.types.PropertyGroup):
    @classmethod
    def register(cls):
        bpy.types.Mesh.circus = PointerProperty(
            name="Circus Mesh Settings",
            description="Circus mesh settings",
            type=cls,
        )
        bpy.types.Curve.circus = PointerProperty(
            name="Circus Mesh Settings",
            description="Circus mesh settings",
            type=cls,
        )
        bpy.types.MetaBall.circus = PointerProperty(
            name="Circus Mesh Settings",
            description="Circus mesh settings",
            type=cls,
        )
    ...
    @classmethod
    def unregister(cls):
        del bpy.types.Mesh.circus
        del bpy.types.Curve.circus
        del bpy.types.MetaBall.circus


class CircusObjectSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Object.circus = PointerProperty(
            name="Circus Object Settings",
            description="Circus object settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Object.circus


class CircusCurveRenderSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.Scene.circus_curves = PointerProperty(
            name="Circus Hair Rendering Settings",
            description="Circus hair rendering settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.Scene.circus_curves


class CircusAOVPass(bpy.types.PropertyGroup):
    name: StringProperty(
        name="Name",
...
class CircusRenderLayerSettings(bpy.types.PropertyGroup):
    ...
    @classmethod
    def register(cls):
        bpy.types.ViewLayer.circus = PointerProperty(
            name="Circus ViewLayer Settings",
            description="Circus ViewLayer Settings",
            type=cls,
        )

    @classmethod
    def unregister(cls):
        del bpy.types.ViewLayer.circus


class CircusDeviceSettings(bpy.types.PropertyGroup):
...
class CircusPreferences(bpy.types.AddonPreferences):
    bl_idname = __package__

    def get_device_types(self, context):
        import _circus
        has_cuda, has_optix, has_opencl = _circus.get_device_types()
    ...
    compute_device_type: EnumProperty(
        ...
        description="Device to use for computation (rendering with Circus)",
        items=get_device_types,
    )

    devices: bpy.props.CollectionProperty(type=CircusDeviceSettings)
    ...
    def get_devices_for_type(self, compute_device_type):
        ...
        device_list = _circus.available_devices(compute_device_type)
    ...
    def get_num_gpu_devices(self):
        import _circus
        device_list = _circus.available_devices(self.compute_device_type)
        num = 0
        for device in device_list:
    ...
    def _draw_devices(self, layout, device_type, devices):
        ...
        if not found_device:
            ...
            col.label(text="Circus will render on the CPU", icon='BLANK1')
            return
        ...
        if device_type == 'OPTIX':
            ...
            col.label(text="Not all Circus features are supported yet", icon='BLANK1')
    ...
    def draw_impl(self, layout, context):
        ...
        import _circus
        has_peer_memory = 0
        for device in _circus.available_devices(self.compute_device_type):
...
class CircusView3DShadingSettings(bpy.types.PropertyGroup):
...
def register():
    bpy.utils.register_class(CircusRenderSettings)
    bpy.utils.register_class(CircusCameraSettings)
    bpy.utils.register_class(CircusMaterialSettings)
    bpy.utils.register_class(CircusLightSettings)
    bpy.utils.register_class(CircusWorldSettings)
    bpy.utils.register_class(CircusVisibilitySettings)
    bpy.utils.register_class(CircusMeshSettings)
    bpy.utils.register_class(CircusObjectSettings)
    bpy.utils.register_class(CircusCurveRenderSettings)
    bpy.utils.register_class(CircusDeviceSettings)
    bpy.utils.register_class(CircusPreferences)
    bpy.utils.register_class(CircusAOVPass)
    bpy.utils.register_class(CircusRenderLayerSettings)
    bpy.utils.register_class(CircusView3DShadingSettings)

    bpy.types.View3DShading.circus = bpy.props.PointerProperty(
        name="Circus Settings",
        type=CircusView3DShadingSettings,
    )


def unregister():
    bpy.utils.unregister_class(CircusRenderSettings)
    bpy.utils.unregister_class(CircusCameraSettings)
    bpy.utils.unregister_class(CircusMaterialSettings)
    bpy.utils.unregister_class(CircusLightSettings)
    bpy.utils.unregister_class(CircusWorldSettings)
    bpy.utils.unregister_class(CircusMeshSettings)
    bpy.utils.unregister_class(CircusObjectSettings)
    bpy.utils.unregister_class(CircusVisibilitySettings)
    bpy.utils.unregister_class(CircusCurveRenderSettings)
    bpy.utils.unregister_class(CircusDeviceSettings)
    bpy.utils.unregister_class(CircusPreferences)
    bpy.utils.unregister_class(CircusAOVPass)
    bpy.utils.unregister_class(CircusRenderLayerSettings)
    bpy.utils.unregister_class(CircusView3DShadingSettings)
