...
void main()
{
    ...
    isect.v = attribs.x;
    isect.object = (gl_InstanceCustomIndexNV & 8388608) | gl_InstanceID;
    isect.type = gl_InstanceCustomIndexNV & 8388607;
    isect.prim = int(uint(gl_PrimitiveID) + push.data_ptr._prim_object.data[isect.type]);
}
