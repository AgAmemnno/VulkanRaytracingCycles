...
float perlin_1d(float x)
{
    ...
    int X;
    int param_1 = X;
    float _932 = floorfrac(param, param_1);
    X = param_1;
    float fx = _932;
    float param_2 = fx;
...
void noise_texture_1d(float co, float detail, float roughness, float distortion, bool color_is_needed, inout float value, inout vec4 color)
{
    ...
    float _2575 = fractal_noise_1d(param_2, param_3, param_4);
    value = _2575;
    if (color_is_needed)
    {
        float param_5 = 1.0;
        ...
        float _2589 = fractal_noise_1d(param_6, param_7, param_8);
        float param_9 = 2.0;
        float param_10 = p + random_float_offset(param_9);
        float param_11 = detail;
        float param_12 = roughness;
        float _2599 = fractal_noise_1d(param_10, param_11, param_12);
        color = vec4(value, _2589, _2599, 0.0);
    }
}
...
float perlin_2d(float x, float y)
{
    ...
    int X;
    int param_1 = X;
    float _1215 = floorfrac(param, param_1);
    X = param_1;
    float fx = _1215;
    float param_2 = y;
    int Y;
    int param_3 = Y;
    float _1223 = floorfrac(param_2, param_3);
    Y = param_3;
    float fy = _1223;
    float param_4 = fx;
...
void noise_texture_2d(vec2 co, float detail, float roughness, float distortion, bool color_is_needed, inout float value, inout vec4 color)
{
    ...
    float _2632 = fractal_noise_2d(param_4, param_5, param_6);
    value = _2632;
    if (color_is_needed)
    {
        float param_7 = 2.0;
        ...
        float _2646 = fractal_noise_2d(param_8, param_9, param_10);
        float param_11 = 3.0;
        vec2 param_12 = p + random_float2_offset(param_11);
        float param_13 = detail;
        float param_14 = roughness;
        float _2656 = fractal_noise_2d(param_12, param_13, param_14);
        color = vec4(value, _2646, _2656, 0.0);
    }
}
...
float perlin_3d(float x, float y, float z)
{
    ...
    int X;
    int param_1 = X;
    float _1312 = floorfrac(param, param_1);
    X = param_1;
    float fx = _1312;
    float param_2 = y;
    int Y;
    int param_3 = Y;
    float _1320 = floorfrac(param_2, param_3);
    Y = param_3;
    float fy = _1320;
    float param_4 = z;
    int Z;
    int param_5 = Z;
    float _1328 = floorfrac(param_4, param_5);
    Z = param_5;
    float fz = _1328;
    float param_6 = fx;
...
void noise_texture_3d(vec4 co, float detail, float roughness, float distortion, bool color_is_needed, inout float value, inout vec4 color)
{
    ...
    float param_7 = detail;
    float param_8 = roughness;
    float _2697 = fractal_noise_3d(param_6, param_7, param_8);
    value = _2697;
    if (color_is_needed)
    {
        float param_9 = 3.0;
        ...
        float param_11 = detail;
        float param_12 = roughness;
        float _2711 = fractal_noise_3d(param_10, param_11, param_12);
        float param_13 = 4.0;
        vec4 param_14 = p + random_float3_offset(param_13);
        float param_15 = detail;
        float param_16 = roughness;
        float _2722 = fractal_noise_3d(param_14, param_15, param_16);
        color = vec4(value, _2711, _2722, 0.0);
    }
}
...
float perlin_4d(float x, float y, float z, float w)
{
    ...
    int X;
    int param_1 = X;
    float _1535 = floorfrac(param, param_1);
    X = param_1;
    float fx = _1535;
    float param_2 = y;
    int Y;
    int param_3 = Y;
    float _1543 = floorfrac(param_2, param_3);
    Y = param_3;
    float fy = _1543;
    float param_4 = z;
    int Z;
    int param_5 = Z;
    float _1551 = floorfrac(param_4, param_5);
    Z = param_5;
    float fz = _1551;
    float param_6 = w;
    int W;
    int param_7 = W;
    float _1559 = floorfrac(param_6, param_7);
    W = param_7;
    float fw = _1559;
    float param_8 = fx;
...
void noise_texture_4d(vec4 co, float detail, float roughness, float distortion, bool color_is_needed, inout float value, inout vec4 color)
{
    ...
    float param_9 = detail;
    float param_10 = roughness;
    float _2771 = fractal_noise_4d(param_8, param_9, param_10);
    value = _2771;
    if (color_is_needed)
    {
        float param_11 = 4.0;
        ...
        float param_13 = detail;
        float param_14 = roughness;
        float _2785 = fractal_noise_4d(param_12, param_13, param_14);
        float param_15 = 5.0;
        vec4 param_16 = p + random_float4_offset(param_15);
        float param_17 = detail;
        float param_18 = roughness;
        float _2796 = fractal_noise_4d(param_16, param_17, param_18);
        color = vec4(value, _2785, _2796, 0.0);
    }
}
...
float svm_wave(uint type, uint bands_dir, uint rings_dir, uint profile, inout vec4 p, float distortion, float detail, float dscale, float droughness, float phase)
{
    ...
    if (!(distortion == 0.0))
    {
        ...
        float _3046 = fractal_noise_3d(param, param_1, param_2);
        n += (distortion * ((_3046 * 2.0) - 1.0));
    }
    if (profile == 0u)
    {
...
void svm_node_tex_wave()
{
    ...
    float _3147 = svm_wave(param, param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9);
    float f = _3147;
    nio.data[0] = f;
}
